...
export const HOME: Record<Locale, HomeSections> = {
  en: {
    ...
    yieldExpr: '(yield% ÷ 100)',
    rtcExampleHtml:
      'Example: 200g raw chicken × 0.75 = <strong class="text-[var(--color-ink)]">150g cooked</strong>',
    ctrExampleHtml:
      'Example: 150g cooked chicken ÷ 0.75 = <strong class="text-[var(--color-ink)]">200g raw</strong>',
    ...
    article: {
      ...
      whyP2:
        'This means you cannot use a single "gram = gram" assumption across your day. A raw to cooked weight conversion calculator solves that by applying each food’s specific yield percentage — the ratio of cooked weight to raw weight — which varies widely between foods. Chicken and beef lose around a quarter of their weight. Spinach loses 70%. White rice almost triples.',
      chickenHeading: 'Raw to Cooked Chicken Weight',
      chickenP1:
        'Raw to cooked chicken weight is probably the most important conversion for anyone tracking protein. Boneless, skinless chicken breast loses approximately 25% of its weight when cooked — whether baked, grilled, or pan-fried. That means 200g raw chicken becomes about 150g cooked.',
      chickenP2:
        'The practical consequence: if you weigh your chicken after cooking and log it as 150g against a raw-weight nutrition label, you will be tracking the macros for only 150g raw — undercounting by 50g. The correct approach is either to weigh raw before cooking, or use a raw to cooked calculator to convert the cooked weight back to its raw equivalent before logging.',
  ...
  es: {
    ...
    rtcExampleHtml:
      'Ejemplo: 200 g de pollo crudo × 0,75 = <strong class="text-[var(--color-ink)]">150 g cocido</strong>',
    ctrExampleHtml:
      'Ejemplo: 150 g de pollo cocido ÷ 0,75 = <strong class="text-[var(--color-ink)]">200 g crudo</strong>',
    ...
    article: {
      ...
      whyP2:
        'Esto significa que no puedes aplicar un simple «gramo = gramo» durante todo el día. Una calculadora de conversión de peso crudo a cocido lo resuelve aplicando el porcentaje de rendimiento específico de cada alimento —la proporción entre el peso cocido y el crudo—, que varía muchísimo de un alimento a otro. El pollo y la res pierden alrededor de una cuarta parte de su peso. La espinaca pierde el 70%. El arroz blanco casi lo triplica.',
      chickenHeading: 'Peso del pollo de crudo a cocido',
      chickenP1:
        'La conversión de peso del pollo de crudo a cocido es probablemente la más importante para quien controla su proteína. La pechuga de pollo sin piel ni hueso pierde aproximadamente el 25% de su peso al cocinarse, ya sea al horno, a la parrilla o a la sartén. Es decir, 200 g de pollo crudo se quedan en unos 150 g cocidos.',
      chickenP2:
        'La consecuencia práctica: si pesas el pollo después de cocinarlo y registras 150 g contra una etiqueta nutricional en crudo, estarás contando los macros de solo 150 g crudos y te faltarán 50 g. Lo correcto es pesarlo en crudo antes de cocinarlo, o usar una calculadora de crudo a cocido para convertir el peso cocido a su equivalente en crudo antes de registrarlo.',
      ...
      usdaP1:
        'Cada cifra de rendimiento que usa este conversor de crudo a cocido procede de fuentes oficiales del USDA, las mismas bases de datos que utilizan dietistas, fabricantes de alimentos e investigadores en salud. Los rendimientos de carne y aves salen de la Tabla de Rendimientos de Cocción del USDA para Carne y Aves. Los de cereales y verduras se obtienen comparando las entradas en crudo y en cocido de USDA FoodData Central. Eso hace que nuestra calculadora sea más fiable que las apps de fitness que se basan en estimaciones colaborativas o promedios sin verificar. Ya estés convirtiendo el peso del pollo de crudo a cocido, comprobando el de la carne molida o calculando la proporción del arroz, cada respuesta se apoya en ciencia publicada y revisada.',
    },
  },
  ...
  fr: {
    ...
    rtcExampleHtml:
      'Exemple : 200 g de poulet cru × 0,75 = <strong class="text-[var(--color-ink)]">150 g cuit</strong>',
    ctrExampleHtml:
      'Exemple : 150 g de poulet cuit ÷ 0,75 = <strong class="text-[var(--color-ink)]">200 g cru</strong>',
    ...
    article: {
      ...
      whyP2:
        'Vous ne pouvez donc pas appliquer un simple « gramme = gramme » tout au long de la journée. Un calculateur de conversion de poids cru-cuit règle le problème en appliquant le pourcentage de rendement propre à chaque aliment — le rapport entre le poids cuit et le poids cru —, qui varie énormément d’un produit à l’autre. Le poulet et le bœuf perdent environ un quart de leur poids. Les épinards en perdent 70 %. Le riz blanc, lui, triple presque.',
      chickenHeading: 'Poids du poulet cru-cuit',
      chickenP1:
        'La conversion du poids du poulet cru en cuit est sans doute la plus importante pour qui suit ses apports en protéines. Le blanc de poulet sans peau ni os perd environ 25 % de son poids à la cuisson, qu’il soit au four, grillé ou poêlé. Autrement dit, 200 g de poulet cru donnent environ 150 g cuits.',
      chickenP2:
        'La conséquence concrète : si vous pesez votre poulet après cuisson et enregistrez 150 g face à une étiquette exprimée en poids cru, vous ne comptabilisez que les macros de 150 g crus — soit 50 g de moins que la réalité. La bonne méthode consiste à peser cru avant cuisson, ou à utiliser un calculateur cru-cuit pour reconvertir le poids cuit en son équivalent cru avant de l’enregistrer.',
  ...
  de: {
    ...
    rtcExampleHtml:
      'Beispiel: 200 g rohes Hähnchen × 0,75 = <strong class="text-[var(--color-ink)]">150 g gegart</strong>',
    ctrExampleHtml:
      'Beispiel: 150 g gegartes Hähnchen ÷ 0,75 = <strong class="text-[var(--color-ink)]">200 g roh</strong>',
  ...
  pt: {
    ...
    rtcExampleHtml:
      'Exemplo: 200 g de frango cru × 0,75 = <strong class="text-[var(--color-ink)]">150 g cozido</strong>',
    ctrExampleHtml:
      'Exemplo: 150 g de frango cozido ÷ 0,75 = <strong class="text-[var(--color-ink)]">200 g cru</strong>',
    ...
    article: {
      ...
      whyP2:
        'Isso significa que não dá para aplicar um simples "grama = grama" ao longo do dia. Uma calculadora de conversão de peso cru para cozido resolve isso aplicando o percentual de rendimento específico de cada alimento — a razão entre o peso cozido e o cru —, que varia bastante de um item para outro. Frango e carne bovina perdem cerca de um quarto do peso. O espinafre perde 70%. O arroz branco quase triplica.',
      chickenHeading: 'Peso do frango de cru para cozido',
      chickenP1:
        'A conversão do peso do frango de cru para cozido é provavelmente a mais importante para quem controla a proteína. O peito de frango sem pele e sem osso perde aproximadamente 25% do peso ao ser cozido — seja assado, grelhado ou frito na frigideira. Ou seja, 200 g de frango cru viram cerca de 150 g cozido.',
      chickenP2:
        'A consequência prática: se você pesa o frango depois de cozinhar e registra 150 g contra um rótulo em peso cru, estará contando os macros de apenas 150 g crus — 50 g a menos. O certo é pesar cru antes de cozinhar, ou usar uma calculadora de cru para cozido para converter o peso cozido de volta ao equivalente cru antes de registrar.',
      ...
      usdaP1:
        'Cada número de rendimento por trás deste conversor de cru para cozido vem de fontes oficiais do USDA — as mesmas bases usadas por nutricionistas, indústrias de alimentos e pesquisadores da área da saúde. Os rendimentos de carnes e aves vêm da Tabela de Rendimentos de Cocção do USDA para Carnes e Aves. Os de grãos e vegetais são obtidos comparando as entradas cruas e cozidas na USDA FoodData Central. Isso torna nossa calculadora mais confiável do que aplicativos de fitness baseados em estimativas colaborativas ou médias não verificadas. Seja convertendo o peso do frango de cru para cozido, conferindo o da carne moída ou calculando a proporção do arroz, cada resposta aqui está ancorada em ciência publicada e revisada.',
    },
  },
  ...
  ja: {
    ...
    yieldExpr: '(歩留まり% ÷ 100)',
    rtcExampleHtml:
      '例: 生の鶏肉200g × 0.75 = <strong class="text-[var(--color-ink)]">加熱後150g</strong>',
    ctrExampleHtml:
      '例: 加熱後の鶏肉150g ÷ 0.75 = <strong class="text-[var(--color-ink)]">生200g</strong>',
    ...
    article: {
      ...
      whyP2:
        'つまり、1日を通して「1gは1g」という前提は使えません。生・加熱後の重量換算計算機は、食材ごとに固有の歩留まり率——加熱後重量と生重量の比——を当てはめることでこれを解決します。この比率は食材によって大きく異なります。鶏肉や牛肉は重量の約4分の1を失い、ほうれん草は70%を失い、白米はほぼ3倍になります。',
      chickenHeading: '鶏肉の生・加熱後の重量',
      chickenP1:
        '鶏肉の生から加熱後への換算は、タンパク質を管理する人にとっておそらく最も重要な換算です。皮なし骨なしの鶏胸肉は、オーブン焼き・グリル・フライパン焼きのいずれでも、加熱すると約25%の重量を失います。つまり生200gの鶏肉は加熱後およそ150gになります。',
      chickenP2:
        '実務上の影響はこうです。加熱後に鶏肉を量って150gとして記録し、それを生重量基準の栄養表示に当てはめると、生150g分の栄養しか計上されず、50g分を取りこぼします。正しいやり方は、加熱前に生で量るか、生・加熱後の計算機で加熱後重量を生重量に戻してから記録することです。',
      ...
      usdaP1:
        'この生・加熱後コンバーターを支える歩留まりの数値はすべて、USDAの公式データ——管理栄養士、食品メーカー、健康分野の研究者が使うのと同じデータベース——に基づいています。食肉と鶏肉の歩留まりはUSDAの食肉・鶏肉調理歩留まり表から、穀物と野菜の歩留まりはUSDA FoodData Centralの生と加熱後のデータを比較して求めています。そのため、利用者の投稿による推定値や未検証の平均値に頼るフィットネスアプリよりも信頼できます。鶏肉の生から加熱後への換算でも、合い挽き肉の重量確認でも、米の比率の計算でも、ここでの答えはすべて公表・査読済みのデータに基づいています。',
    },
  },
  ...
  ko: {
    ...
    yieldExpr: '(수율 % ÷ 100)',
    rtcExampleHtml:
      '예: 생닭 200g × 0.75 = <strong class="text-[var(--color-ink)]">조리 후 150g</strong>',
    ctrExampleHtml:
      '예: 조리된 닭고기 150g ÷ 0.75 = <strong class="text-[var(--color-ink)]">생 200g</strong>',
    ...
    article: {
      ...
      whyP2:
        '따라서 하루 종일 "1g은 1g"이라는 가정을 그대로 쓸 수는 없습니다. 생·조리 중량 변환 계산기는 식품마다 다른 고유 수율 — 조리 후 중량과 생 중량의 비율 — 을 적용해 이 문제를 해결합니다. 이 값은 식품에 따라 크게 달라집니다. 닭고기와 소고기는 무게의 약 4분의 1을 잃고, 시금치는 70%를 잃으며, 백미는 거의 세 배가 됩니다.',
      chickenHeading: '닭고기 생·조리 중량',
      chickenP1:
        '닭고기의 생 중량과 조리 후 중량 변환은 단백질을 관리하는 사람에게 아마 가장 중요한 계산일 것입니다. 껍질과 뼈를 제거한 닭 가슴살은 오븐에 굽든, 직화로 굽든, 팬에 굽든 조리하면 무게의 약 25%가 줄어듭니다. 생 200g이 조리 후 약 150g이 된다는 뜻입니다.',
      chickenP2:
        '실제로 어떤 일이 생기냐면, 조리한 뒤 닭고기를 재서 150g으로 기록하고 이를 생중량 기준 영양성분표에 대입하면 생 150g 분량의 영양소만 계산되어 50g만큼 빠집니다. 올바른 방법은 조리 전에 생으로 재거나, 생·조리 계산기로 조리 후 중량을 생중량으로 되돌린 뒤 기록하는 것입니다.',
      ...
      usdaP1:
        '이 생·조리 변환기를 뒷받침하는 모든 수율 수치는 USDA 공식 자료 — 영양사, 식품 제조사, 보건 연구자가 사용하는 것과 같은 데이터베이스 — 에서 나옵니다. 육류와 가금류 수율은 USDA 육류·가금류 조리 수율표에서 가져왔고, 곡물과 채소 수율은 USDA FoodData Central의 생·조리 항목을 비교해 산출했습니다. 그래서 이용자 제보 추정치나 검증되지 않은 평균값에 의존하는 피트니스 앱보다 신뢰할 수 있습니다. 닭고기의 생·조리 중량을 변환하든, 다진 소고기의 중량을 확인하든, 쌀의 비율을 따지든, 여기서 나오는 모든 답은 공개·검증된 데이터에 근거합니다.',
    },
  },
  ...
  it: {
    ...
    yieldExpr: '(resa % ÷ 100)',
    rtcExampleHtml:
      'Esempio: 200 g di pollo crudo × 0,75 = <strong class="text-[var(--color-ink)]">150 g cotto</strong>',
    ctrExampleHtml:
      'Esempio: 150 g di pollo cotto ÷ 0,75 = <strong class="text-[var(--color-ink)]">200 g crudo</strong>',
  ...
  hi: {
    ...
    yieldExpr: '(यील्ड % ÷ 100)',
    rtcExampleHtml:
      'उदाहरण: 200g कच्चा चिकन × 0.75 = <strong class="text-[var(--color-ink)]">150g पका</strong>',
    ctrExampleHtml:
      'उदाहरण: 150g पका चिकन ÷ 0.75 = <strong class="text-[var(--color-ink)]">200g कच्चा</strong>',
    ...
    article: {
      ...
      whyP2:
        'इसका मतलब यह है कि आप पूरे दिन "एक ग्राम मतलब एक ग्राम" नहीं मान सकते। कच्चे से पके वजन का कैलकुलेटर हर खाद्य पदार्थ का अपना यील्ड प्रतिशत — यानी पके और कच्चे वजन का अनुपात — लगाकर यह समस्या हल करता है, और यह अनुपात एक चीज से दूसरी चीज में काफी बदलता है। चिकन और बीफ अपना करीब एक-चौथाई वजन खोते हैं। पालक 70% खो देता है। सफेद चावल लगभग तीन गुना हो जाता है।',
      chickenHeading: 'चिकन का कच्चे से पके वजन में बदलाव',
      chickenP1:
        'प्रोटीन ट्रैक करने वाले किसी भी व्यक्ति के लिए चिकन का कच्चे से पके वजन में बदलाव शायद सबसे जरूरी गणना है। बिना हड्डी और बिना त्वचा वाला चिकन ब्रेस्ट पकाने पर करीब 25% वजन खो देता है — चाहे बेक करें, ग्रिल करें या तवे पर तलें। यानी 200g कच्चा चिकन पकने पर लगभग 150g रह जाता है।',
      chickenP2:
        'व्यावहारिक नतीजा यह है: अगर आप चिकन पकाने के बाद तौलकर 150g दर्ज करते हैं और उसे कच्चे वजन वाले पोषण लेबल पर लगाते हैं, तो आप सिर्फ 150g कच्चे के मैक्रो गिनेंगे और 50g छूट जाएगा। सही तरीका है या तो पकाने से पहले कच्चा तौलना, या कच्चे-से-पके कैलकुलेटर से पके वजन को उसके कच्चे बराबर मान में बदलकर दर्ज करना।',
      ...
      usdaP1:
        'इस कच्चे-से-पके कनवर्टर के पीछे का हर यील्ड आंकड़ा आधिकारिक USDA स्रोतों से आता है — वही डेटाबेस जिनका इस्तेमाल आहार विशेषज्ञ, खाद्य निर्माता और स्वास्थ्य शोधकर्ता करते हैं। मांस और मुर्गी के यील्ड USDA की मांस और मुर्गी कुकिंग यील्ड तालिका से लिए गए हैं। अनाज और सब्जियों के यील्ड USDA FoodData Central में कच्ची और पकी प्रविष्टियों की तुलना से निकाले गए हैं। इसीलिए हमारा कैलकुलेटर उन फिटनेस ऐप्स से ज्यादा भरोसेमंद है जो उपयोगकर्ताओं के अनुमानों या बिना जांचे औसतों पर चलते हैं। आप चिकन का कच्चे से पके वजन बदल रहे हों, कीमे का वजन जांच रहे हों या चावल का अनुपात निकाल रहे हों — यहां हर जवाब प्रकाशित और परखे गए डेटा पर टिका है।',
    },
  },
};
